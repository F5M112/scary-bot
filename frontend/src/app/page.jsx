...
const FEATURES = [
  ...
  { emoji: '👋', key: 'welcome',  descKey: 'welcomeDescShort' },
...
const FEATURE_LABELS = {
  ar: {
    ...
    welcomeDescShort:    'تنبيهات فورية عند دخول عضو للسيرفر .',
  ...
  en: {
    ...
    welcomeDescShort:    'Instant notifications when a member joins the server.',
